            ...
            <div class="col-md-6">
                ...
                <form action="{{ url('/finalizarCompra') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="string" class="form-control" id="numeroTarjeta" name="numeroTarjeta" placeholder="1234 5678 9012 3456" maxlength="19" required>
                    </div>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="fechaExpiracion" class="form-label">Fecha de Expiración</label>
                            <input type="string" class="form-control" id="fechaExpiracion" name="fechaExpiracion" placeholder="MM/AA" maxlength="5" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="cvv" class="form-label">CVV</label>
                            <input type="string" class="form-control" id="cvv" name="cvv" placeholder="123" maxlength="4" required>
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="nombreTitular" class="form-label">Nombre del Titular</label>
                        <input type="string" class="form-control" id="nombreTitular" name="nombreTitular" placeholder="Como aparece en la tarjeta" required>
                    </div>

                    <div class="mb-3">
                        <label for="dni" class="form-label">DNI del Titular</label>
                        <input type="string" class="form-control" id="dni" name="dniTitular" placeholder="Número de documento" required>
                    </div>
